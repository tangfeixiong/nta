...
var rules []string = []string{
	...
	"sudo iptables -A SECGRP_INPUT -i eps03 --ipv4 -p tcp --dport 22 -s 10.10.0.0/16 -j ACCEPT",
	"sudo iptables -A SECGRP_OUTPUT -i eps03 --ipv4 -p udp -s 10.11.11.0/8 -j ACCEPT",
...
go test -v -run Execution ./pkg/manager
*/
